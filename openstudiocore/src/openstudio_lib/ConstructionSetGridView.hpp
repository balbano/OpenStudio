...
#ifndef OPENSTUDIO_CONSTRUCTIONSETGRIDVIEW_HPP
#define OPENSTUDIO_CONSTRUCTIONSETGRIDVIEW_HPP
...
class ConstructionSetGridController;

class ConstructionSetGridView : public QWidget
{
  Q_OBJECT

public:

  ConstructionSetGridView(bool isIP, const model::Model & model, QWidget * parent = 0);

  virtual ~ConstructionSetGridView() {}
...
class ConstructionSetGridController : public OSGridController
{
...
public:
  ...
  ConstructionSetGridController(bool isIP,
    const QString & headerText,
    IddObjectType iddObjectType,
    model::Model model,
    std::vector<model::ModelObject> modelObjects);

  virtual ~ConstructionSetGridController() {}
...
private:
  ...
  ConstructionSetGridView * constructionSetGridView();

};

} // openstudio

#endif // OPENSTUDIO_CONSTRUCTIONSETGRIDVIEW_HPP
