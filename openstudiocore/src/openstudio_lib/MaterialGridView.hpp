...
#ifndef OPENSTUDIO_MATERIALGRIDVIEW_HPP
#define OPENSTUDIO_MATERIALGRIDVIEW_HPP
...
class MaterialGridController;

class MaterialGridView : public QWidget
{
  Q_OBJECT

public:

  MaterialGridView(bool isIP, const model::Model & model, QWidget * parent = 0);

  virtual ~MaterialGridView() {}
...
private:
  ...
  REGISTER_LOGGER("openstudio.MaterialGridView");

  bool m_isIP;

  MaterialGridController * m_gridController = nullptr;
...
class MaterialGridController : public OSGridController
{
...
public:
  ...
  MaterialGridController(bool isIP,
    const QString & headerText,
    IddObjectType iddObjectType,
    model::Model model,
    std::vector<model::ModelObject> modelObjects);

  virtual ~MaterialGridController() {}
...
#endif // OPENSTUDIO_MATERIALGRIDVIEW_HPP
